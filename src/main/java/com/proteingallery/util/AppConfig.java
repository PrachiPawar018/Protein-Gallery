...
public class AppConfig {
    ...
    public static final String DB_PASSWORD = getEnvOrDefault("DB_PASSWORD", "password"); // Change this to your local pass or use env
    ...
    // Email Configuration
    public static final String SMTP_USER = getEnvOrDefault("SMTP_USER", "your-email@example.com");
    public static final String SMTP_PASSWORD = getEnvOrDefault("SMTP_PASSWORD", "your-app-password");
